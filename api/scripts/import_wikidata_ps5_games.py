...
def main():
    parser = argparse.ArgumentParser(description="Import PS5 games from Wikidata.")
    parser.add_argument("--limit", type=int, default=10)
    parser.add_argument(
        "--platform-qid",
        default="Q63184502",
        help="Wikidata QID for platform (default: PS5 Q63184502).",
    )
    parser.add_argument(
        "--insecure",
        action="store_true",
    ...
    with psycopg.connect(dsn) as conn:
        platform_id = get_platform_id(conn, "ps5")
