...
CREATE TABLE IF NOT EXISTS app.airpay_diagnostic_runs (
    id uuid PRIMARY KEY,
...
CREATE UNIQUE INDEX IF NOT EXISTS airpay_diagnostic_one_active
    ON app.airpay_diagnostic_runs ((state)) WHERE state = 'active';
CREATE TABLE IF NOT EXISTS app.airpay_diagnostic_items (
    run_id uuid NOT NULL REFERENCES app.airpay_diagnostic_runs(id),
