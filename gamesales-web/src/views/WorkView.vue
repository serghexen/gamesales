...
const defaultFalseActions = new Set([
  ...
  'accounts.edit',
  'accounts.delete',
  ...['create', 'view', 'edit'].flatMap((context) => [
    `accounts.${context}.field.date`,
    `accounts.${context}.field.region`,
    `accounts.${context}.field.purchase_cost`,
    `accounts.${context}.field.email_password`,
    `accounts.${context}.field.auth_code`,
    `accounts.${context}.field.reserves`,
    `accounts.${context}.field.products`,
    `accounts.${context}.field.slots`,
  ]),
