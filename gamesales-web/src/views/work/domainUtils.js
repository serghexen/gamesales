export const TAB_KEYS = ['deals', 'accounts', 'products', 'ns-gift', 'interhub', 'telegram', 'analytics', 'catalogs', 'finance', 'voucher-catalog', 'voucher-warehouse', 'users', 'profile', 'dashboard']
