  ...
  <section class="panel panel--wide">
    ...
    <div class="panel__body">
      ...
      <WorkAccountsTableSection
        ...
        :format-account-games-line="ctx.formatAccountGamesLine"
      ...
      <WorkAccountEditorModal
        ...
        :account-games-loading="ctx.accountGamesLoading"
        ...
        :account-game-titles="ctx.accountGameTitles"
        :edit-account-game-search="ctx.editAccountGameSearch"
        :set-edit-account-game-search="ctx.setEditAccountGameSearch"
        :filtered-edit-account-games="ctx.filteredEditAccountGames"
        ...
        :get-deal-game-title-tooltip="ctx.getDealGameTitleTooltip"
        :get-deal-game-title-display="ctx.getDealGameTitleDisplay"
        :format-date="ctx.formatDate"
        :accounts-error="ctx.accountsError"
        :accounts-ok="ctx.accountsOk"
        :new-account="ctx.newAccount"
        :account-game-search="ctx.accountGameSearch"
        :set-account-game-search="ctx.setAccountGameSearch"
        :filtered-account-games="ctx.filteredAccountGames"
      />
