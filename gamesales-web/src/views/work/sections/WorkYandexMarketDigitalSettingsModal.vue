        ...
        <div class="modal__body">
            ...
            <div class="ozon-key-settings__block-head">
              ...
              <div class="ozon-key-settings__block-actions">
                <div class="ozon-digital-modal__auto-switch">
                  <label class="switch" :title="yandexMarketSandboxMode ? 'Автовыдача будет доступна после подключения обработки заказов Маркета' : 'Автовыдача через поставщика'">
                    <input v-model="autoIssueEnabled" type="checkbox" :disabled="yandexMarketSandboxMode || !yandexMarketStockSettings.interhub_service_id" :aria-label="yandexMarketSandboxMode ? 'Автовыдача пока не подключена' : 'Автовыдача через поставщика для Яндекс Маркета'" />
          ...
          <section v-if="!yandexMarketSandboxMode" class="ozon-catalog-details-modal__work-block ozon-key-settings__block" :class="{ 'is-open': isSupportDeliveryOpen }">
            <div class="ozon-key-settings__block-head">
              ...
              <div class="ozon-key-settings__block-actions">
                <div class="ozon-digital-modal__auto-switch">
                  <label class="switch" title="Отправить сообщение покупателю вместо кода после поставщика и ручного пула">
          ...
          <section v-if="yandexMarketSandboxMode" class="ozon-digital-modal__orders">
            <div class="ozon-digital-modal__orders-head"><div><h4>Локальная выдача fake-заказов</h4><p class="muted">Ключи сохраняются в локальном test-пуле. Яндекс Маркет и поставщик не вызываются.</p></div><span class="ozon-digital-modal__manual-count">{{ pendingSandboxOrders.length }}</span></div>
